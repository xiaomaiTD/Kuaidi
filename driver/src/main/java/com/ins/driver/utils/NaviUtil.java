...
public class NaviUtil {
    ...
    //######################################
    //通过URI API接口启调地图工具  高德
    //http://lbs.amap.com/api/uri-api/guide/android-uri-explain/navi/
    //######################################
    ...
    public static void startNative_Gaode(Context context, Location loc) {
        ...
        try {
            ...
            Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("androidamap://navi?sourceApplication=CC房车-车主&poiname=重庆快易科技&lat=" + loc.getLat() + "&lon=" + loc.getLng() + "&dev=1&style=2"));
